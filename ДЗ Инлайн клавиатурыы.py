...
async def inform(call):
    await call.message.answer('Соблюдая норму калорий и ваше здоровье будет в норме! '
                              'Hажмите кнопку Рассчитать калории, чтоб рассчитать вашу норму калорий!, '
                              'Нажмите кнопку Формула расчёта чтоб получить формулу рассчета!', reply_markup=kb)
    await call.answer()
